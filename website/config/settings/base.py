...
_default_database = django_settings.DATABASE_URL
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql",
        "NAME": django_settings.DATABASE_URL.rsplit("/")[-1],
        "USER": _default_database.user,
        "PASSWORD": _default_database.password,
        "HOST": _default_database.host,
        "PORT": _default_database.port,
    }
}
